...
class Vector:
    ...
    def cross(self, other):
        ...
        return Vector([y1 * z2 - z1 * y2, z1 * x2 - x1 * z2, x1 * y2 - y1 * x2], self.is_column)
    ...
    def to_col_matrix(self):
        ...
        return CoreMatrix([[x] for x in self.data]) # Each element becomes its own row, making it a column matrix
